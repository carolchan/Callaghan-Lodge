			 ...
			 <li id="nav_menu" class="widget-container widget_nav_menu">
				<div class="subnav-menu">
				 <ul id="menu-sub-nav" class="menu">
				  ...
				  <li><a href="http://www.callaghancountry.com/wordpress/rates-packages/corporate-teambuilding/">Corporate Teambuilding</a></li>
				  <li><a href="http://www.callaghancountry.com/wordpress/rates-packages/specialty-reservations/">Specialty Reservations</a></li>
				 </ul>
			  </div><!-- .subnav-menu -->
			</ul>
